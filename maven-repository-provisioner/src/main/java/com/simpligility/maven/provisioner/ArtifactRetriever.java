...
public class ArtifactRetriever {
    ...
    public void retrieve(
            List<String> artifactCoordinates,
            String sourceUrl,
            String username,
            String password,
    ...
    private List<ArtifactResult> getArtifactResults(
            List<String> artifactCoordinates,
            boolean includeProvidedScope,
            boolean includeTestScope,
            boolean includeRuntimeScope) {
        ...
        DependencyFilter depFilter = DependencyFilterUtils.classpathFilter(JavaScopes.TEST);
    ...
    private void getArtifact(Gav gav, String packagingOverride, String classifier) {
        ...
        Artifact artifact =
                new DefaultArtifact(gav.getGroupId(), gav.getArtifactId(), classifier, packaging, gav.getVersion());
